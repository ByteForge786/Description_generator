...
class AttributeDescriptionGenerator:
    ...
    def create_prompt(self, attributes: List[Tuple[str, str]], company_context: str = "", filename: str = "") -> str:
        """
        ...
        Args:
            ...
            filename: Name of the input file being processed
            
        Returns:
            Formatted prompt string
        """
        prompt = f"""Based on the company context, file context ({filename}), and sample values, generate specific and detailed descriptions for the following attributes.
...
"""
    ...
    def process_batch(self, batch: List[Tuple[str, str]], company_context: str, filename: str) -> Dict:
        """
        ...
        """
        try:
            prompt = self.create_prompt(batch, company_context, filename)
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
                ...
                for i in range(0, len(attributes), self.batch_size):
                    ...
                    future = executor.submit(self.process_batch, batch, company_context, filename)
